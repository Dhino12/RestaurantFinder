...
/* harmony export */ });
/* harmony import */ var _views_components_detail_Detail__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4716);
/* harmony import */ var _views_components_favorite_favorite__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8002);
/* harmony import */ var _views_components_home_Home__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(480);



var Routes = {
  '/': _views_components_home_Home__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z,
  '/detail/:id': _views_components_detail_Detail__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z,
  '/favorite': _views_components_favorite_favorite__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z
};
...
var UrlParser = {
  parseActiveWithCombiner: function parseActiveWithCombiner() {
    ...
    var splitUrl = this._urlSplitter(url);
...
var DrawerInitiator = /*#__PURE__*/function () {
  function DrawerInitiator() {
    _classCallCheck(this, DrawerInitiator);
  }

  _createClass(DrawerInitiator, null, [{
    key: "init",
    ...
    key: "_toggleDrawer",
    value: function _toggleDrawer(event, drawer) {
      event.stopPropagation();
      drawer.classList.toggle('show');
    }
  }, {
    key: "_closeDrawer",
    value: function _closeDrawer(event, drawer) {
      event.stopPropagation();
...
/* harmony export */   "Z": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _views_template_likeButton__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9124);
/* harmony import */ var _views_template_unlikeButton__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8412);
...
var LikeInitiator = {
  ...
  _renderLike: function _renderLike() {
    ...
    this._likeButtonContainer.replaceChild(this.stringToNode((0,_views_template_likeButton__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)()), this._likeButtonContainer.children[0]);

    var buttonLike = document.querySelector('#likeButton');
    buttonLike.classList.add('unactive');
    buttonLike.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _this4._favoriteRestaurant.putRestauarant(_this4._restaurant);
  ...
  _renderLiked: function _renderLiked() {
    ...
    this._likeButtonContainer.replaceChild(this.stringToNode((0,_views_template_unlikeButton__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z)()), this._likeButtonContainer.children[0]);

    var buttonLike = document.querySelector('#unlikeButton');
    buttonLike.classList.add('active');
    buttonLike.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              _this5._favoriteRestaurant.deleteRestaurant(_this5._restaurant.id);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (LikeInitiator);
