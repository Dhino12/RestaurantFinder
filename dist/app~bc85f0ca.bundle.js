...
/* harmony export */ });
/* harmony import */ var _utils_DrawerInitiator__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6089);
/* harmony import */ var _routes_url_parser__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(836);
/* harmony import */ var _routes_routes__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7506);
...
var App = /*#__PURE__*/function () {
  ...
  _createClass(App, [{
    ...
    value: function _initialAppShell() {
      _utils_DrawerInitiator__WEBPACK_IMPORTED_MODULE_2__/* ["default"].init */ .Z.init({
        button: this._button,
        drawer: this._drawer,
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                url = _routes_url_parser__WEBPACK_IMPORTED_MODULE_0__/* ["default"].parseActiveWithCombiner */ .Z.parseActiveWithCombiner();
                page = _routes_routes__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z[url];
                console.log(page);
                _context.next = 5;
                return page.render();
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (App); // export default main;
...
/* harmony export */   "Z": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _data_favorite_idb__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(171);
/* harmony import */ var _data_RestourantSource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2594);
/* harmony import */ var _routes_url_parser__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(836);
/* harmony import */ var _utils_LikeInitiator__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(5711);
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
var Detail = /*#__PURE__*/function () {
  ...
  _createClass(Detail, null, [{
    ...
    key: "afterRender",
    value: function () {
      var _afterRender = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        var _this = this;

        var url, restaurantDetail, _yield$restaurantDeta, restaurant, expandReview;
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                _context3.next = 3;
                return _data_RestourantSource__WEBPACK_IMPORTED_MODULE_1__/* ["default"].detailRestaurant */ .Z.detailRestaurant(url.id);
              ...
              case 6:
                _yield$restaurantDeta = _context3.sent;
                restaurant = _yield$restaurantDeta.restaurant;
                ...
                _utils_LikeInitiator__WEBPACK_IMPORTED_MODULE_3__/* ["default"].init */ .Z.init({
                  likeButtonContainer: document.querySelector('.favorite'),
                  favoriteRestaurant: _data_favorite_idb__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z,
                  restaurant: restaurant
                });
                expandReview = document.querySelector('#expandReview');
                expandReview.addEventListener('click', function (e) {
                  e.target.classList.toggle('d-none');
                  document.querySelector('review-list')._setCustomerReview = restaurant.customerReviews;
                });

                document.querySelector('review-form')._onSendReview = /*#__PURE__*/function () {
                      ...
                      while (1) {
                        switch (_context2.prev = _context2.next) {
                          case 0:
                            event.preventDefault();
                            _context2.next = 3;
                            return _this.postReview(restaurant);
    ...
    key: "postReview",
    value: function () {
      var _postReview = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(_ref2) {
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                _context4.prev = 3;
                _context4.next = 6;
                return _data_RestourantSource__WEBPACK_IMPORTED_MODULE_1__/* ["default"].postRestaurant */ .Z.postRestaurant({
                  id: id,
                  name: name.value,
                  review: review.value
                });
